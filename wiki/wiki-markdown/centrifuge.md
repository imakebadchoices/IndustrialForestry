...
- **Beeswax**, from most combs, used to make capsules, casings, and Wax Casts.
- **Honey drops**, which the [Squeezer](squeezer.md) presses into honey fluid.
- **Specialty drops** — propolis, pollen, honeydew, royal jelly and rarer products — depending on the comb, and therefore on the bee that made it.
...
See [Beekeeping](apiculture.md) for where combs come from and [Factory machines](carpenter.md) for what beeswax and honey feed into next.

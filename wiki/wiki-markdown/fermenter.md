...
- **Organic material** — saplings, sugar cane, and similar plant matter, placed in the resource slot. This is what gets turned into Biomass.
- **A catalyst** — a **fermentation item** such as Fertilizer, Mulch, or Compost, which powers the reaction. Each lasts a different length of time and processes a different amount of material before it is used up.
- **A liquid** — usually **Water**, but Honey or Juice can be used, which change how much Biomass you get.

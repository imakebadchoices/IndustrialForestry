...
public class CoreClientHandler implements IClientModuleHandler {
	...
	private static void registerItemColors(RegisterColorHandlersEvent.Item event) {
		...
		event.register(ClientManager.FORESTRY_ITEM_COLOR, ApicultureItems.COMB.item());
		event.register(ClientManager.FORESTRY_ITEM_COLOR, ApicultureItems.COMB_EXTRACT.item());
